...
db.sync({ force: true }).then(async () => {
    ...
    const users = await User.bulkCreate([
        ...
        { name: 'Farmacias del pueblo', email: "farma@gmail.com", password: "1234", company: "Farmacias del pueblo", accepted: true, role: "Empresa" },
        { name: 'Gabarino', email: "garbarino@gmail.com", password: "1234", company: "Garbarino", accepted: true, role: "Empresa" },
        { name: 'GPS Farma', email: "gpsfarma@gmail.com", password: "1234", company: "GPS Farma", accepted: true, role: "Empresa" },
    ...
    users.map(user => {
        ...
        const shuffleCadeterias = [...cadeterias].sort(() => { return 0.5 - Math.random() })
        if (user.role === "Empresa") user.addCadeteria(shuffleCadeterias.slice(start, end))
